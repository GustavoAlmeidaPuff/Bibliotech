              ...
              >
                <VideoOnScroll videoRef={showcaseVideoRef}>
                  <VideoContainer 
                    ...
                    onClick={() => isVideoInView ? toggleVideoSound() : setIsShowcaseVideoModalOpen(true)}
                    ...
                    {isVideoInView ? (
                      <>
                        <iframe
                          ...
                          width="100%"
                          height="100%"
                          src={`https://www.youtube.com/embed/p1EwxbQ323k?autoplay=1&mute=${isVideoMuted ? 1 : 0}&loop=1&playlist=p1EwxbQ323k&controls=0&modestbranding=1&rel=0`}
                          ...
                          style={{ 
                            border: 'none',
                            borderRadius: '12px',
                            pointerEvents: 'none' // Impede cliques no iframe, mas permite no container
                          }}
                        />
                        {/* Indicador de som */}
                        <div
